export const HEDGE_FUND = {
  ...
  description:
    "Deposit SOL/USDC, run live Jupiter sleeves (max $100), catalog stocks + crypto mints, 1% start fee and 10% of profit on liquidate. Paper mode still available on request.",
  ...
  examplePrompts: [
    ...
    "Create live strategy with NVDA META BTC, horizon 30 days, capital 100",
